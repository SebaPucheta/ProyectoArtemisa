<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="GenerarEstadisticaDeVenta.aspx.cs" Inherits="ProyectoArtemisa.GenerarEstadistica" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_cuerpo" runat="server">
    <div class="row">
        <div class="container col-lg-offset-3 col-lg-7" id="div_form">
            ...
            <!-- Titulo -->
            <div class="row">
                <h1 class="text-primary text-center"><b>Estadística de venta</b></h1>
            </div>
            <br />
            <!-- Fecha desde y hasta  -->
            <div class="row">
            ...
            <%-- Reporte --%>
            <div>
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="900px" Width="90%" CssClass="center-block"></rsweb:ReportViewer>
            </div>
        </div>
    </div>
