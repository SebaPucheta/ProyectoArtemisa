<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="GenerarCierreVenta_143.aspx.cs" Inherits="ProyectoArtemisa.Reportes.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_cuerpo" runat="server">
     <div class="row">
        <div class="container col-lg-offset-3 col-lg-7" id="div_form">
            ...
            <!-- Titulo -->
            <div class="row">
                <h1 class="text-primary text-center"><b>Reporte de cierre de venta</b></h1>
            </div>
            <br />
            <!-- Fecha desde y hasta  -->
            <div class="row">
