...
{
    public partial class GenerarReporteResmasUtilizadas_146 : System.Web.UI.Page
    {
        ...
        protected void showReport()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = "Reportes/GenerarReporteResmasUtilizadas_146.rdlc";
        ...
        private DataTable getData(DateTime fechaDesde, DateTime fechaHasta)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("sp_ventaXapunte", cnn);
