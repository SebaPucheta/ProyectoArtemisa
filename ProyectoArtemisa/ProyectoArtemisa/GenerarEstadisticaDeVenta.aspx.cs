...
{
    public partial class GenerarEstadistica : System.Web.UI.Page
    {
        ...
        protected void showReport()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = "Reportes/GenerarEstadisticaDeVenta.rdlc";
        ...
        private DataTable getData(DateTime fechaDesde, DateTime fechaHasta)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("sp_estadisticaDeVentaApunte", cnn);
